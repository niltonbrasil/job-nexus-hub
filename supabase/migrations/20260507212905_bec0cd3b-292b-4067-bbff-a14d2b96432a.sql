...
CREATE INDEX IF NOT EXISTS idx_contract_services_patient ON public.contract_services(patient_id);
  ...
  LOOP
    ...
    FOR i IN 0..(blocks-1) LOOP
      ...
      INSERT INTO public.demands (
        ...
        block_index, plan_snapshot, patient_id
      ) VALUES (
